...
bool start_stop_rotasi_welding = false;
...
void setup()
{
    ...
    myStepper.setMaxSpeed(2000);      // SPEED = Steps / second
    myStepper.setAcceleration(10000); // ACCELERATION = Steps /(second)^2
