...
AccelStepper myStepper(AccelStepper::DRIVER, stepPinStepper);
...
void loop()
{
    ...
    {
        myStepper.setSpeed(kecepatan_rotasi_welding); // the motor accelerates to this speed exactly without overshoot. Try other values.
        myStepper.runSpeed();
